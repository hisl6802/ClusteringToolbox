...
class LocallyWeighted:
    ...
    def clustCompare(refClust):
        ...
        #refClust = LocallyWeighted.clustFinder()
        ECI = {}
        ...
        for key in refClust:
            ...
            for i in baseClust:
                ...
                logging.info("Probability being calculated...")
                p = LocallyWeighted.probClust(keys, key, localClust, refClust) 
    ...
    def consensus(ECI, refClust,data):
        '''
